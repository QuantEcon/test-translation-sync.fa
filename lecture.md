...
translation:
  ...
  headings:
    ...
    '*Matplotlib* Visualization Basics': '*Matplotlib* اصول تجسم‌سازی'
...
قالب‌های مختلف فایل به توابع خواندن متفاوتی نیاز دارند:
...
مقادیر مورد انتظار $\mathbb{E}[X]$ نتایج میانگین را نشان می‌دهند:
...
- **سؤال**: کدام سریع‌تر است: `numpy` یا پایتون خالص؟
...
ابزارهای برنامه‌نویسی مانند **numpy**، *pandas* و `matplotlib` برای پژوهش اقتصادی مدرن ضروری هستند. این کتابخانه‌ها را به‌خوبی بیاموزید تا بتوانید داده‌ها را به‌طور کارآمد تحلیل و نتایج را تجسم‌سازی کنید.
