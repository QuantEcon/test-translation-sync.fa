...
translation:
  ...
  headings:
    ...
    '"Edge Cases" and [Special] {Characters}': «موارد حاشیه‌ای» و [کاراکترهای] {ویژه}
...
این درس مفاهیم و ابزارهای برنامه‌نویسی ضروری برای تحلیل اقتصادی مدرن را پوشش می‌دهد.
...
فرمت‌های مختلف فایل نیازمند توابع خواندن متفاوتی هستند:
...
- **سؤال**: کدام سریع‌تر است: `numpy` یا پایتون ساده؟
...
## «موارد حاشیه‌ای» و [کاراکترهای] {ویژه}

این بخش کاراکترهای ویژه گوناگون را در عنوان‌ها آزمایش می‌کند.
...
ابزارهای برنامه‌نویسی مانند **numpy**، *pandas* و `matplotlib` برای پژوهش‌های اقتصادی مدرن ضروری هستند. بر این کتابخانه‌ها مسلط شوید تا بتوانید داده‌ها را به‌طور کارآمد تحلیل کرده و نتایج را تجسم بخشید.
