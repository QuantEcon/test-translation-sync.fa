...
translation:
  ...
  headings:
    ...
    '"Edge Cases" and [Special] {Characters}': '"موارد لبه‌ای" و [ویژه] {نویسه‌ها}'
...
این درس مفاهیم و ابزارهای برنامه‌نویسی را که برای تحلیل اقتصادی مدرن ضروری هستند پوشش می‌دهد.
...
پرسش‌های رایج درباره Python برای اقتصاد:

- **پرسش**: کدام سریع‌تر است: `numpy` یا Python ساده؟
...
ابزارهای برنامه‌نویسی مانند **numpy**، *pandas*، و `matplotlib` برای پژوهش‌های اقتصادی مدرن ضروری هستند. این کتابخانه‌ها را به‌طور کامل بیاموزید تا بتوانید داده‌ها را به‌طور کارآمد تحلیل کرده و نتایج را به تصویر بکشید.
