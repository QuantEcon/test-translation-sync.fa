...
translation:
  ...
  headings:
    ...
    '*Matplotlib* Visualization Basics': مبانی تصویرسازی با *Matplotlib*
...
کتابخانه `numpy` عملیات آرایه‌ای کارآمدی را برای محاسبات عددی فراهم می‌کند. آرایه‌ها پایه و اساس محاسبات علمی در پایتون هستند.

آرایه‌های NumPy از عملیات برداری پشتیبانی می‌کنند و از حلقه‌های کند پایتون جلوگیری می‌کنند:
...
## مبانی تصویرسازی با *Matplotlib*

*Matplotlib* کتابخانه ترسیم بنیادی برای پایتون است. این کتابخانه کنترل دقیقی بر ظاهر نمودار فراهم می‌کند.
...
- **پاسخ**: بله، اما برای مجموعه‌داده‌هایی بزرگ‌تر از حافظه RAM، استفاده از `dask` را در نظر بگیرید
...
ابزارهای برنامه‌نویسی مانند **numpy**، *pandas* و `matplotlib` برای تحقیقات اقتصادی مدرن ضروری هستند. این کتابخانه‌ها را برای تحلیل کارآمد داده‌ها و مصورسازی نتایج فرابگیرید.
