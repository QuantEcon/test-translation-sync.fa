...
translation:
  ...
  headings:
    ...
    '"Edge Cases" and [Special] {Characters}': '"موارد مرزی" و [ویژه] {نویسه‌ها}'
...
کتابخانه `numpy` عملیات آرایه‌ای کارآمد برای محاسبات عددی فراهم می‌کند. آرایه‌ها پایه و اساس محاسبات علمی در پایتون هستند.
...
*Matplotlib* کتابخانه پایه‌ای رسم نمودار برای پایتون است. این کتابخانه کنترل دقیقی بر ظاهر نمودار فراهم می‌کند.
...
پروژه [QuantEcon](https://quantecon.org) ابزارهای تخصصی برای مدل‌سازی اقتصادی فراهم می‌کند. برای جزئیات به [مستندات](https://quanteconpy.readthedocs.io/) مراجعه کنید.
...
ارزش‌های مورد انتظار $\mathbb{E}[X]$ نمایانگر پیامدهای میانگین هستند:
...
سؤالات رایج درباره Python برای اقتصاد:

- **سؤال**: کدام سریع‌تر است: `numpy` یا Python ساده؟
...
## "موارد مرزی" و [ویژه] {نویسه‌ها}

این بخش نویسه‌های ویژه گوناگون را در سرتیترها آزمایش می‌کند.
...
ابزارهای برنامه‌نویسی مانند **numpy**، *pandas* و `matplotlib` برای تحقیقات اقتصادی مدرن ضروری هستند. این کتابخانه‌ها را برای تحلیل کارآمد داده‌ها و نمایش بصری نتایج به‌طور کامل بیاموزید.
