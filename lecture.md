...
translation:
  ...
  headings:
    ...
    '*Matplotlib* Visualization Basics': '*Matplotlib* اصول مبانی تجسم‌سازی'
...
کتابخانه `numpy` عملیات کارآمد آرایه‌ای را برای محاسبات عددی فراهم می‌کند. آرایه‌ها پایه و اساس محاسبات علمی در پایتون هستند.
...
## *Matplotlib* اصول مبانی تجسم‌سازی

*Matplotlib* کتابخانه اصلی رسم نمودار برای پایتون است. این کتابخانه کنترل دقیقی بر ظاهر نمودار فراهم می‌کند.
...
- **پاسخ**: `numpy` معمولاً ۱۰ تا ۱۰۰ برابر برای عملیات عددی سریع‌تر است
...
این بخش نویسه‌های خاص گوناگون را در عنوان‌ها آزمایش می‌کند.
...
ابزارهای برنامه‌نویسی مانند **numpy**، *pandas*، و `matplotlib` برای پژوهش‌های اقتصادی مدرن ضروری هستند. این کتابخانه‌ها را فرابگیرید تا بتوانید داده‌ها را به‌طور کارآمد تحلیل کرده و نتایج را به تصویر بکشید.
